...
<body>
	...
	<div class="wrapper-content">
		<div class="slider">
			<h2 class="page-title">Files & Downloads</h2>
			<div class="downloads">
				<ul>				
					<li>
						<i class="fa fa-file-o"></i>
						<div class="file-info">	
							<h2>Team Dignitas 2015 Trackmania 2 Stadium</h2>								
							<p>application/octet-stream</p>	
							<p><b>Size:</b> 5006kb</p>	
						</div>
						<button class="read-more">Download</button>					
					</li>
					<li>
						<i class="fa fa-file-o"></i>						
						<div class="file-info">							
							<h2>xyp9x CSGO config 2014</h2>								
							<p>application/x-rar </p>	
							<p><b>Size:</b> 36kb</p>	
						</div>
						<button class="read-more">Download</button>					
					</li>
