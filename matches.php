...
<body>
	...
	<nav class="navigation">
		<ul class="nav-links">
			...
			<a href="#" style="color:#F9C700"><li style="background-color: #333; border-top-left-radius: 3px; border-top-right-radius: 3px;">Matches</li></a>
		...
		<div class="slider">
			...
			<div class="matches">
				<ul class="matches-container">
					<li>
						<div class="pagination matches-pag">
							<ul>
								<li><a href="">1</a></li>
								<li><a href="">2</a></li>
								<li><a href="">3</a></li>
					...
					<li class="result-item">
						<div class="result-heding-box">
							<h2>EU CHALLENGER SERIES</h2>
							<p>Wed 1st jul 2015</p>
						</div>
						<ul class="match-on">
							<li>
								<h2>Team Dignitas LOLEU</h2>
								<p>0</p>
							</li>
							<li>
								<h2>Team Overclockers UK</h2>
								<p>0</p>
							</li>
						</ul>
