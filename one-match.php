...
<body>
	...
	<nav class="navigation">
		<ul class="nav-links">
			...
			<a href="matches.php"><li class="active">Matches</li></a>
		...
		<div class="slider">
			...
			<div class="matches-outer">
				<div class="matches-inner">
					<div class="cover" style="background: url(photos/teams/team1.jpg); background-size: cover; background-repeat: no-repeat;"></div>
					<h4 class="heading">
						<span class="name">99Damage Masters #2</span>
						<span class="date">Tue 7th Jul 2015</span>
					</h4>
					<div class="two-teams">
						<div class="team-left">
							<div class="pic-container" style="background: url(photos/logo/main-logo.png); background-size: cover; background-repeat: no-repeat; margin-left: 20px;"></div>
							<h3>n00b alliance</h3>
							<h4>2</h4>
						</div>
						<div class="vs"><span>VS</span></div>
						<div class="team-right">
							<!-- <div class="pic-container" style="background: url(photos/logo/main-logo.png); background-size: cover; background-repeat: no-repeat;"></div> -->
							<h3>Other Team</h3>
							<h4>2</h4>
						</div>
					</div>
