...
<body>
	...
	<nav class="navigation">
		<ul class="nav-links">
			...
			<a href="#" style="color:#F9C700"><li style="background-color: #333; border-top-left-radius: 3px; border-top-right-radius: 3px;">Galleries</li></a>
			...
			<ul class="gallery-ul">
				<li class="gallery-li">
					<div class="gallery-type">
						<div class="heading-container">
							<a href="#">
								<h2>League of Legends East Coast Convention</h2>
							</a>
							<span class="number-of-photos">36 Photos</span>
						</div>
				...
				<li class="gallery-li">
					<div class="gallery-type">
						<div class="heading-container">
							<a href="#">
								<h2>Dreamhack Summer 2015 - Day 1</h2>
							</a>
							<span class="number-of-photos">68 Photos</span>
						</div>
						<div class="thumb-container">
							<ul class="thumbs">
								<li>
				...
				<li class="gallery-li">
					<div class="gallery-type">
						<div class="heading-container">
							<a href="#">
								<h2>Scan Day - Nvidia 980Ti Launch Day</h2>
							</a>
							<span class="number-of-photos">30 Photos</span>
						</div>
						<div class="thumb-container">
							<ul class="thumbs">
								<li>
				...
				<li class="gallery-li">
					<div class="gallery-type">
						<div class="heading-container">
							<a href="#">
								<h2>LCS Summer Split 2015 - Week 1</h2>
							</a>
							<span class="number-of-photos">58 Photos</span>
						</div>
						<div class="thumb-container">
							<ul class="thumbs">
								<li>
